CREATE DATABASE  IF NOT EXISTS `conmed` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `conmed`;
-- MySQL dump 10.13  Distrib 8.0.19, for Win64 (x86_64)
--
-- Host: localhost    Database: conmed
-- ------------------------------------------------------
...
CREATE TABLE `paciente` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nome` varchar(50) DEFAULT NULL,
  `grp_sanguineo` tinyint(1) DEFAULT NULL,
  `logradouro` varchar(100) DEFAULT NULL,
  `numero` mediumint DEFAULT NULL,
  `cidade` varchar(30) DEFAULT NULL,
  `uf` varchar(2) DEFAULT NULL,
...
--
-- Dumping routines for database 'conmed'
--
...
-- Dump completed on 2020-06-03 20:58:17
